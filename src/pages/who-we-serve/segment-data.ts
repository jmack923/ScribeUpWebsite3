...
export const SEGMENTS: Record<SegmentSlug, SegmentData> = {
  banks: {
    ...
    heroHeadline: "Drive user primacy and engagement with subscription management",
    heroSubline: "Embed an off-the-shelf best-in-class subscription management experience into your users' digital banking experiences.",
    showPlatforms: true,
  ...
  "credit-unions": {
    ...
    heroHeadline: "Drive member primacy and engagement with subscription management",
    heroSubline: "Embed an off-the-shelf best-in-class subscription management experience into your member's digital banking experiences.",
    showPlatforms: true,
    cusoMention: true,
  ...
  fintechs: {
    ...
    heroSubline: "Flexibly integrate off-the-shelf subscription management or API-based features to drive user value, heightened engagement and personalized opportunities to cross-sell your core offerings.",
    showPlatforms: false,
    ctaHeadline: "Built for fintechs like yours",
    ctaSubline: "See the embedded experience and integration path for your stack.",
    bullets: [
      "Upsell to your premium for advanced functionality like calendar sync or 1-click cancellation",
      "Personal loan, insurance, EWA etc. — your core products",
      "SDK, iFrame, or API",
    ],
    proof: [
    ...
    metrics: [
      { label: "Premium plan conversion", value: "10%+", desc: "For advanced functionality like calendar sync or 1-click cancellation" },
      { label: "Retention", value: "5%+", desc: "Lift from deeper engagement and alerts" },
      { label: "Cross-sell conversion", value: "11%", desc: "Personal loans, insurance, EWA — your core offering" },
    ],
  },
};
