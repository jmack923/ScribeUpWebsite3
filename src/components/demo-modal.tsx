      ...
      {isOpen && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 sm:p-6">
          ...
          <motion.div
            ...
            className="relative w-full max-w-[440px] bg-white/80 backdrop-blur-[24px] rounded-[32px] shadow-[0_24px_80px_rgba(0,0,0,0.18),0_0_0_1px_rgba(255,255,255,0.4)_inset] overflow-hidden border border-slate-200/50"
          >
              ...
              {!isSuccess ? (
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  >
                    <button
                      type="submit"
                      className="group relative w-full h-[56px] bg-[#2f6fff] hover:bg-blue-600 text-white rounded-full font-semibold transition-all shadow-[0_4px_14px_rgba(47,111,255,0.39)] overflow-hidden"
                    >
                      ...
                      {/* Inner Top Edge Glow */}
                      <div className="absolute inset-x-0 top-0 h-px bg-white/25 shadow-[0_1px_4px_rgba(255,255,255,0.5)]" />
                    </button>
                  </motion.div>
                </form>
              ) : (
