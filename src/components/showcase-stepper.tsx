...
const toneStyles: Record<NonNullable<ShowcaseStep["tone"]>, { rail: string; dot: string }> = {
  blue: { rail: "from-blue-600 via-indigo-500 to-sky-400", dot: "bg-blue-600/80" },
  indigo: { rail: "from-indigo-600 via-blue-600 to-sky-400", dot: "bg-indigo-600/80" },
  sky: { rail: "from-sky-500 via-blue-600 to-indigo-500", dot: "bg-sky-500/80" },
};
