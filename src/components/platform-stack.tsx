  ...
  if (kind === "Track") {
    return (
      <div className="relative w-full h-full rounded-2xl bg-white/72 overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute inset-0 bg-[radial-gradient(60%_60%_at_80%_0%,rgba(84,100,255,0.12),transparent_60%)] opacity-65" />
        <div className="relative px-2.5 py-2">
          <div className="flex items-center justify-between gap-2">
      ...
      <div className="grid sm:grid-cols-2 xl:grid-cols-3 gap-5 md:gap-6">
        {pillars.map((p) => {
          ...
          return (
            ...
            >
              <div aria-hidden="true" className={`pointer-events-none absolute -inset-24 bg-[radial-gradient(closest-side,rgba(84,100,255,0.18),transparent_62%)] blur-[16px] opacity-70`} />
