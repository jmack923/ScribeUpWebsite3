    ...
    >
      ...
      <div
        ...
        className={`pointer-events-none absolute inset-0 ${
          tone === "blue"
            ? "bg-[radial-gradient(60%_60%_at_12%_0%,rgba(84,100,255,0.12),transparent_62%),radial-gradient(55%_55%_at_88%_30%,rgba(30,162,255,0.08),transparent_66%)]"
            : "bg-[radial-gradient(60%_60%_at_12%_0%,rgba(84,100,255,0.10),transparent_62%),radial-gradient(55%_55%_at_88%_30%,rgba(30,162,255,0.06),transparent_66%)]"
        } opacity-100`}
      />
...
export function PhoneShowcase({
  ...
  React.useEffect(() => {
    ...
    const shouldPlay = () => inView && isVisible && !rm && document.visibilityState === "visible";
  ...
  return (
    <div ref={wrapRef} className={`${container} overflow-visible ${className ?? ""}`}>
      ...
      <div aria-hidden="true" className="pointer-events-none absolute -z-10 inset-0">
        <div className="absolute -top-10 left-1/2 -translate-x-1/2 h-[28rem] w-[28rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(84,100,255,0.06),transparent_62%)] blur-2xl" />
        <div className="absolute -bottom-10 left-1/2 -translate-x-1/2 h-[24rem] w-[24rem] rounded-full bg-[radial-gradient(circle_at_center,rgba(59,130,246,0.045),transparent_64%)] blur-2xl" />
      </div>
          ...
          >
            {showVideo ? (
              <video
                ...
                onLoadedData={(e) => {
                  if (document.visibilityState === "visible" && inView && isVisible && !rm) {
